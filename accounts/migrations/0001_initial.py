    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, help_text='- 를 제외한 번호만 입력하세요.', max_length=11, validators=[django.core.validators.RegexValidator('^010[1-9]\\d{7}$')], verbose_name='휴대폰')),
